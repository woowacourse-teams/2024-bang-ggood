...
public enum ExceptionCode {
    ...
    INVALID_PARAMETER(HttpStatus.BAD_REQUEST, ClientExceptionCode.INTERNAL_SERVER_ERROR, "잘못된 인자입니다."),
    ...
    PASSWORD_HASHING_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, ClientExceptionCode.PASSWORD_HASHING_ERROR, "비밀번호 해싱 중 오류가 발생했습니다."),
    ...
    // Room
    ROOM_FLOOR_AND_LEVEL_INVALID(HttpStatus.BAD_REQUEST, ClientExceptionCode.CHECKLIST_ERROR, "방이 지상층일 경우에만 층수를 입력할 수 있습니다."),


    // OccupancyMonth
    OCCUPANCY_MONTH_INVALID(HttpStatus.BAD_REQUEST, ClientExceptionCode.CHECKLIST_ERROR, "입주 가능월은 1부터 12 사이 혹은 null 값만 가능합니다."),

    // OccupancyPeriod
    OCCUPANCY_PERIOD_INVALID(HttpStatus.BAD_REQUEST, ClientExceptionCode.CHECKLIST_ERROR, "입주 가능 기간은 초, 중, 말 혹은 null 값만 가능합니다."),
