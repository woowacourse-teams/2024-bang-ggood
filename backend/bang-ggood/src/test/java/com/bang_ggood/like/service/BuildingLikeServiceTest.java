...
class BuildingLikeServiceTest extends IntegrationTestSupport {

    @Autowired
    private BuildingRepository buildingRepository;
    @Autowired
    private BuildingLikeService buildingLikeService;
    @Autowired
    ...
    void deleteBuildingLike() {
        ...
        // when
        buildingLikeService.deleteLike(user, building.getId());

        // then
        assertThat(buildingLikeRepository.count()).isEqualTo(0);
    }
    ...
    void deleteBuildingLike_notFound() {
        ...
        // when & then
        assertThatCode(() -> buildingLikeService.deleteLike(user, building.getId()))
