...
class ChecklistMaintenanceServiceTest extends IntegrationTestSupport {
    ...
    void createChecklistMaintenance() {
        ...
        //when
        checklistMaintenanceService.createMaintenance(checklistMaintenances);

        //then
        assertThat(checklistMaintenanceRepository.findAllByChecklistId(checklist.getId())).hasSize(2);
    }
