...
public class QuestionFixture {
    ...
    public static void init(CategoryRepository categoryRepository, QuestionRepository questionRepository) {
        ...
        QUESTION1_CATEGORY1 = questionRepository.save(new Question(CATEGORY1, "testTitle1", "testSubTitle1", true));
        QUESTION2_CATEGORY1 = questionRepository.save(new Question(CATEGORY1, "testTitle2", "testSubTitle2", true));
        QUESTION3_CATEGORY2 = questionRepository.save(new Question(CATEGORY2, "testTitle3", "testSubTitle3", true));
        QUESTION4_CATEGORY2 = questionRepository.save(new Question(CATEGORY2, "testTitle4", "testSubTitle3", true));
        QUESTION5_CATEGORY2 = questionRepository.save(new Question(CATEGORY2, "testTitle5", "testSubTitle3", true));
    }
}
