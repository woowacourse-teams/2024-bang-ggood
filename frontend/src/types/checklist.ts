...
import { EmotionNameWithNull } from '@/types/emotionAnswer';
...
export interface ChecklistQuestionWithAnswer extends ChecklistQuestion, ChecklistAnswer {}

export interface ChecklistAnswer {
  questionId: number;
  grade: EmotionNameWithNull | null;
  memo: string | null;
}
